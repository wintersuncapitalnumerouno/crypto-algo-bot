# =============================================================
# live/executor_stochvol.py — StochVol V4 Live Executor — Wallet 2
# =============================================================
#
...
class StochVolExecutor:
    ...
    def _enter_trade(self, coin: str, signal: dict, equity: float):
        ...
        try:
            ...
            send_telegram(
                f"<b>StochVol WALLET 2 ENTRY — {coin} {direction_emoji} {direction.upper()}</b>\n"
    ...
    def _exit_trade(self, coin: str, reason: str, current_price: float, candle_time: str):
        ...
        try:
            ...
            send_telegram(
                f"<b>StochVol WALLET 2 EXIT — {coin} {pos.direction.upper()}</b>\n"
                f"Reason: {reason}\n"
    ...
    def run(self):
        log("🚀 StochVol V4 (wallet 2) executor running. Ctrl+C or pkill to stop.")
        send_telegram("🤖 <b>StochVol V4 — WALLET 2 started</b>\nServer: Legatus | Coins: " + ", ".join(COINS))
        while True:
            try:
                self.run_once()
