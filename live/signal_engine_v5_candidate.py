# =============================================================
# live/signal_engine_v5_candidate.py
# =============================================================
# V5 candidate signal engine.
# Identical to signal_engine_stochvol.py except:
#   - imports params_v5_candidate instead of params_v4
#   - entry_window=4 (was 3)
#   - vol_min_ratio=0.2 (was 0.3)
#
...
from strategies.stochvol.params_v5_candidate import get_default_params
...
class StochVolSignalEngine:
    ...
    def __init__(self):
        ...
        self.p      = self.params
        print(f'[signal_engine] StochVol V5-candidate | stoch_k={self.p["stoch_k"]} | entry_window={self.p["entry_window"]} | vol_min_ratio={self.p["vol_min_ratio"]}', flush=True)

    def get_signal(self, coin: str, df_5m: pd.DataFrame) -> dict:
        """
        Run StochVol on 5m candle DataFrame.
